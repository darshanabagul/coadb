									        ...
									        <td valign="top" style="padding:0">
												<table border="0" cellpadding="10" cellspacing="0" width="100%">
													<tbody>
														<tr align="center">
										                <td width="200">
									                		<a href="<?php echo get_home_url();?>" style="text-decoration: none;color: #2f5bad;">Home</a>
														</td>
														<td width="200">
									                		<a href="<?php echo get_home_url();?>/surname-listing" style="text-decoration: none;color: #2f5bad;">Merch</a>
														</td>
														<td width="200">
									                		<a href="<?php echo get_home_url();?>/contact" style="text-decoration: none;color: #2f5bad;">Contact Us</a>
														</td>
														</tr>
								                   </tbody>
												</table>
